    ...
    <div class="row">
        ...
        <div class="col-lg-10 py-4 px-4">
                        ...
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                <tr class="cliente-card">
                                    ...
                                    <td class="text-center align-middle">
                                        <a href="{{ route('admin.ordenes.index', ['usuario' => $cliente->id]) }}" 
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white border-0">
                    <h6 class="fw-700 mb-0">Clientes Nuevos</h6>
                </div>
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                @empty
                                <tr>
                                    <td colspan="4" class="text-center text-muted py-4">No hay clientes nuevos en este período</td>
                                </tr>
                                @endforelse
                            </tbody>
                        </table>
