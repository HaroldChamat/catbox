...
<div class="musica-hero">
    <div class="container position-relative">
        <div class="row align-items-center">
            <div class="col-lg-8">
                <h1 class="display-3 fw-bold mb-3">Musica</h1>
                <p class="lead mb-4">{{ $categoria->descripcion ?? 'Descubre nuestra colección de Musica' }}</p>
                <div class="d-flex gap-2 flex-wrap">
                    <span class="badge badge-musica px-3 py-2">
...
<div class="container my-5">
    <div class="row g-4">
        ...
        <div class="col-lg-3 col-md-4 col-sm-6">
            <div class="card musica-card h-100 shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h4 class="mb-0 fw-bold" style="color: #ff9a9e">
