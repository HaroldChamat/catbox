...
<div class="pokemon-hero">
    <div class="container position-relative">
        <div class="row align-items-center">
            <div class="col-lg-8">
                <h1 class="display-3 fw-bold mb-3">Pokemon</h1>
                <p class="lead mb-4">{{ $categoria->descripcion ?? 'Descubre nuestra colección de Pokemon' }}</p>
                <div class="d-flex gap-2 flex-wrap">
                    <span class="badge badge-pokemon px-3 py-2">
